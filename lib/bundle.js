...
/***/ function(module, exports, __webpack_require__) {
	...
	const Computer = __webpack_require__(8);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var bomber_walkdown = new Image();
	bomber_walkdown.src = './img/bomber_walkdown.gif';
	var bomber = new Image();
	bomber.src = './img/bomber.gif';
	var bomber_down = new Image();
	bomber_down.src = './img/bomber_down.gif';
	var bomber_up = new Image();
	bomber_up.src = './img/bomber_up.gif';
	var bomber_left = new Image();
	bomber_left.src = './img/bomber_left.gif';
	var bomber_right = new Image();
	bomber_right.src = './img/bomber_right.gif';
	...
	GameMap.prototype.renderCharacters = function (ctx) {
	  for (var i = 0; i < this.characters.length; i++) {
	    if (this.characters[i].playerNum === 1) {
	      ...
	      ctx.drawImage(bomber2, this.characters[i].pos[0]-1, this.characters[i].pos[1]-19);
	    }
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	Character.prototype.isLeftPathBlocked = function () {
	  ...
	  if (this.gameMap.isPath(topLeftMapPos) && this.gameMap.isPath(bottomLeftMapPos)) {
	    if (this.gameMap.onBomb(this.getMapBombPos(this.pos)) !== false) {
	      return false;
	...
	Character.prototype.move = function (move) {
	  ...
	  if (this.isLeftPathBlocked() && this.isTopPathBlocked()) {
	    if (deltaX < 0) {
	      deltaX = 0;
	    }
	    if (deltaY < 0) {
