...
/***/ function(module, exports, __webpack_require__) {
	...
	GameView.prototype.stop = function () {
	  let sx = (this.gameMap.checkWinner() - 1) * 272;
	  ctx.drawImage(gameOver, sx, 0, 272, 195, 0, 0, 272, 228);
	  if (this.gameMap.musicOn) {
	    this.gameMap.currentAudio.pause();
	    evergreen.play();
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	GameMap.prototype.checkWinner = function () {
	  ...
	  //   if (this.findCharacterByNum(1) && this.numPlayers === 1) {
	  //     return 1;
	  //   } else if (this.numPlayers === 1 || this.findCharacterByNum(1) === false) {
	  //     return 3;
	  //   } else {
	  //     return false;
	  //   }
	  ...
	  //   if (this.findCharacterByNum(1) && this.numPlayers === 1) {
	  //     return 1;
	  //   } else if (this.findCharacterByNum(2) && this.numPlayers === 1) {
	  //     return 2;
	  //   } else if (this.findCharacterByNum(1) === false && this.findCharacterByNum(2) === false) {
	  //     return 3;
	  //   } else {
	  //     return false;
	  //   }
	  ...
	  if (this.computer === true) {
	    if (this.p1Lives === 0) {
	      return 3;
	    } else if (this.numPlayers === 1 && this.findCharacterByNum(1) === 0) {
	      return 1;
	    } else {
	      return false;
	    }
	    ...
	    if (this.p1Lives === 0 && this.p2Lives === 0) {
	      ...
	      return 1;
	    } else if (this.numPlayers === 1 && this.findCharacterByNum(2) === 0) {
	      return 2;
	    } else {
	      return false;
	    }
	  }
	  // if (this.computer === true && this.numPlayers === 1) {
	...
	GameMap.prototype.checkCharacter = function () {
	  this.characters.forEach( (character, index) => {
	    ...
	    this.isBottomPathUnsafe(character) || this.isLeftPathUnsafe(character)) && !character.invincible) {
	      ...
	      this.removeCharacter(this.findCharacterByNum(character.playerNum));
	    }
