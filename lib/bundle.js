...
/***/ function(module, exports) {
	...
	Computer.prototype.findAdjacentTile = function () {
	  ...
	  if (Math.random() < 0.5 && this.gameMap.isPath(right) && !this.isDangerous(right) && this.gameMap.isBomb(right) === false && this.isPreviousMapPos(right, previousMapPosX, previousMapPosY) && this.gameMap.isPowerup(right)) {
	    mapPos = right;
	    this.previousDirection = 'right';
	    return { direction: 'right', mapPos: mapPos };
	  } else if (Math.random() < 0.5 && this.gameMap.isPath(left) && !this.isDangerous(left) && this.gameMap.isBomb(left) === false && this.isPreviousMapPos(left, previousMapPosX, previousMapPosY) && this.gameMap.isPowerup(left)) {
	    mapPos = left;
	  ...
	  } else if (this.gameMap.isPath(up) && !this.isDangerous(up) && this.gameMap.isBomb(up) === false &&  this.isPreviousMapPos(up, previousMapPosX, previousMapPosY) && this.gameMap.isPowerup(up)) {
	    mapPos = up;
	    this.previousDirection = 'up';
	    return { direction: 'up', mapPos: mapPos };
	  } else if (Math.random() < 0.5 && this.gameMap.isPath(right) && !this.isDangerous(right) && this.gameMap.isBomb(right) === false && this.isPreviousMapPos(right, previousMapPosX, previousMapPosY) && this.gameMap.isPowerup(right)) {
	    mapPos = right;
	    this.previousDirection = 'right';
	    return { direction: 'right', mapPos: mapPos };
	  } else if (Math.random() < 0.5 && this.gameMap.isPath(right) && !this.isDangerous(right) && this.gameMap.isBomb(right) === false && this.isPreviousMapPos(right, previousMapPosX, previousMapPosY)) {
	    mapPos = right;
	    this.previousDirection = 'right';
	    return { direction: 'right', mapPos: mapPos };
	  } else if (Math.random() < 0.5 && this.gameMap.isPath(left) && !this.isDangerous(left) && this.gameMap.isBomb(left) === false && this.isPreviousMapPos(left, previousMapPosX, previousMapPosY)) {
	    mapPos = left;
	    this.previousDirection = 'left';
	    return { direction: 'left', mapPos: mapPos };
	    ...
	    this.previousDirection = 'down';
	    return { direction: 'down', mapPos: mapPos };
	  } else if (this.gameMap.isPath(up) && !this.isDangerous(up) && this.gameMap.isBomb(up) === false &&  this.isPreviousMapPos(up, previousMapPosX, previousMapPosY)) {
	    mapPos = up;
	    this.previousDirection = 'up';
	    return { direction: 'up', mapPos: mapPos };
	  } else if (Math.random() < 0.5 && this.gameMap.isPath(right) && !this.isDangerous(right) && this.gameMap.isBomb(right) === false && this.isPreviousMapPos(right, previousMapPosX, previousMapPosY)) {
	    ...
	    this.previousDirection = 'right';
	    return { direction: 'right', mapPos: mapPos };
	  } else if (this.gameMap.isPath(left) && !this.isDangerous(left) && this.gameMap.isBomb(left) === false && this.isPreviousMapPos(left, previousMapPosX, previousMapPosY)) {
	    mapPos = left;
	    this.previousDirection = 'left';
	    return { direction: 'left', mapPos: mapPos };
	  } else if (this.gameMap.isPath(right) && !this.isDangerous(right) && this.gameMap.isBomb(right) === false && this.isPreviousMapPos(right, previousMapPosX, previousMapPosY)) {
	    mapPos = right;
	    this.previousDirection = 'right';
	    return { direction: 'right', mapPos: mapPos };
	    ...
	    this.previousDirection = 'down';
	    return { direction: 'down', mapPos: mapPos };
	  } else if (this.gameMap.isPath(up) && !this.isDangerous(up) && this.gameMap.isBomb(up) === false ) {
	    mapPos = up;
	    this.previousDirection = 'up';
	    return { direction: 'up', mapPos: mapPos };
	  } else if (this.gameMap.isPath(right) && !this.isDangerous(right) && this.gameMap.isBomb(right) === false ) {
	    mapPos = right;
	    this.previousDirection = 'right';
	    return { direction: 'right', mapPos: mapPos };
	  } else if (this.gameMap.isPath(left) && !this.isDangerous(left) && this.gameMap.isBomb(left) === false ) {
	    mapPos = left;
	    this.previousDirection = 'left';
	    return { direction: 'left', mapPos: mapPos };
	    ...
	    if (this.gameMap.isPath(down) && this.gameMap.isBomb(down) === false) {
	      ...
	      this.previousDirection = 'down';
	      return { direction: 'down', mapPos: mapPos };
	    } else if (this.gameMap.isPath(up) && this.gameMap.isBomb(up) === false) {
	      mapPos = up;
	      this.previousDirection = 'up';
	      return { direction: 'up', mapPos: mapPos };
	    } else if (this.gameMap.isPath(right) && this.gameMap.isBomb(right) === false) {
	      mapPos = right;
	      this.previousDirection = 'right';
	      return { direction: 'right', mapPos: mapPos };
	    } else if (this.gameMap.isPath(left) && this.gameMap.isBomb(left) === false) {
	      mapPos = left;
	      this.previousDirection = 'left';
	      return { direction: 'left', mapPos: mapPos };
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	Character.prototype.move = function (move) {
	  ...
	  if (this.alive) {
	    ...
	    } else if (this.isPathBlocked('right') && this.isPathBlocked('up') && this.isPathBlocked('down')) {
	      if (deltaY > 0 || deltaY < 0) { deltaY = 0; }
	    } else if (this.isPathBlocked('left') && this.isPathBlocked('down') && this.isPathBlocked('right')) {
	      if (deltaX > 0 || deltaX < 0) { deltaX = 0; }
